...
To improve the quality of our model, we decided to remove outliers as analaysis shows marginal improvements to R\^2 and marginal deterioration to the Press Statistic. We notice the following outliers:
...
Mean(SalePrice) = b0 + b1(OverallQual) + b2(OverallCond) + b3(YearBuilt) + b4(
